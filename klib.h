...
void charbin(long, char*, unsigned int); //converte un numero a binario di tot cifre
unsigned int compara(char*, char*); // rende il numero di caratteri comuni alle due stringhe
